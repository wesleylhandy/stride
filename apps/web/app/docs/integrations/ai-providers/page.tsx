...
async function getDocContent(): Promise<ParsedDoc> {
  ...
  const filePath = join(repoRoot, 'docs', 'integrations', 'ai-providers.md');
...
export default async function AIProvidersDocsPage() {
  ...
  return (
    <PageContainer variant="constrained">
      <DynamicDocumentationPageContent
        ...
        description="Configure AI providers (Ollama, OpenAI, Anthropic) for AI-powered issue triage and analysis"
        sections={sections}
