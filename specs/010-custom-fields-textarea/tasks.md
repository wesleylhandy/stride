...
- [x] T001 [US1] Add 'textarea' to CustomFieldTypeSchema enum in packages/yaml-config/src/schema.ts
- [x] T002 [P] [US1] Add unit test for textarea type validation in packages/yaml-config/src/tests/schema.test.ts
- [x] T003 [P] [US1] Verify TypeScript types auto-update from Zod schema in packages/types/src/project.ts
...
- [x] T004 [US1] Add 'textarea' case to renderCustomFieldInput switch statement using MarkdownEditor component in packages/ui/src/organisms/IssueForm.tsx
- [x] T005 [US1] Add 'textarea' case to createFormSchema switch statement (z.string() validation) in packages/ui/src/organisms/IssueForm.tsx
- [x] T006 [P] [US1] Add unit test for textarea field form rendering in packages/ui/src/organisms/**tests**/IssueForm.test.tsx
- [x] T007 [P] [US1] Add unit test for textarea field form validation (required/optional) in packages/ui/src/organisms/**tests**/IssueForm.test.tsx
...
- [x] T008 [US1] Add 'textarea' case to renderCustomFieldValue function using MarkdownRenderer component in packages/ui/src/organisms/IssueDetail.tsx
- [x] T009 [P] [US1] Add unit test for textarea field markdown rendering in packages/ui/src/organisms/**tests**/IssueDetail.test.tsx
- [x] T010 [P] [US1] Add integration test for textarea field display with markdown content in packages/ui/src/organisms/**tests**/IssueDetail.test.tsx
...
- [x] T011 [P] [US1] Add textarea field type description to Custom Field Configuration section in docs/configuration/reference.md
- [x] T012 [P] [US1] Add YAML example showing textarea field usage in docs/configuration/reference.md
- [x] T013 [P] [US1] Document markdown support and rendering behavior for textarea fields in docs/configuration/reference.md
...
- [x] T014 [US1] Add E2E test for creating issue with textarea custom field in apps/web/e2e/issues.spec.ts
- [x] T015 [US1] Add E2E test for editing issue with textarea custom field in apps/web/e2e/issues.spec.ts
- [x] T016 [P] [US1] Add E2E test for markdown rendering in issue view for textarea fields in apps/web/e2e/issues.spec.ts
- [x] T017 [P] [US1] Add E2E test for required textarea field validation in apps/web/e2e/issues.spec.ts
- [x] T018 [P] Add regression test verifying existing custom field types (text, number, dropdown, date, boolean) still work in packages/ui/src/organisms/**tests**/IssueForm.test.tsx
- [x] T019 [P] Add regression test verifying existing custom field types display correctly in packages/ui/src/organisms/**tests**/IssueDetail.test.tsx
